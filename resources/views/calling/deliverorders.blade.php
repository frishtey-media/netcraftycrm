...
@section('content')
    ...
    <div class="table-responsive d-none d-md-block">
        <div class="client-scroll mb-3">
            ...
            <a href="{{ route('calling.deliverorders') }}" class="client-chip {{ request('client_id') ? '' : 'active' }}">
                All
            </a>

            @foreach ($clients as $row)
                <a href="{{ route('calling.deliverorders', ['client_id' => $row->client_id]) }}"
